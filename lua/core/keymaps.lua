...
-- Create a fast keymap for <leader>x to delete the current buffer
vim.keymap.set('n', '<leader>x', function()
    local buf = vim.api.nvim_get_current_buf()  -- Get the current buffer ID
    vim.api.nvim_buf_delete(buf, { force = true })  -- Delete buffer (even if unsaved)
    --print("Buffer " .. buf .. " deleted!")  -- Optional: Confirmation message
